            ...
            if (currentVersion != latestVersion) {
                ...
                var doInstall = dialog.showMessageBox(win, {
                    ...
                    if (response === 0) {
                        ...
                        opn("https://github.com/kritik123/Cantela");
    ...
    if (!rpc.user) { // Garbage
        ...
        rpc.login({
            ...
            if (couldConnect) {
                ...
                if (win) win.setTitle("Cantela v" + currentVersion + " - Synced With Discord");
                setActivity();
            } else {
                connectedToDiscord = false;
                if (win) win.setTitle("Cantela v" + currentVersion);
            }
        }).catch((e) => {});
    } else {
        connectedToDiscord = true;
...
function createWindow() {
    ...
    win = new BrowserWindow({
        ...
        title: "Cantela v" + currentVersion,
        icon: __dirname + "/images/favicon.png"
    });
